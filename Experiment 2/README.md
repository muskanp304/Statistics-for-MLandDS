...
## 🖼️ Visual Output Generated directly from `Exp2.ipynb` Code
...
1. **Output Folder**: Images are saved in `Experiment 2/images/`.
2. **Export Visuals via Code**:
   ```python
   plt.savefig("images/scatter_glucose_age.png", dpi=300, bbox_inches='tight')
   ```
3. **Embed in Markdown**:
   ```markdown
