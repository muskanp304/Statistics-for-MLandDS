...
## 🖼️ Visual Output Generated directly from `exp3.ipynb` Code
...
1. **Output Directory**: Images are saved under `Experiment 3/images/`.
2. **Save Notebook Plots**:
   ```python
   plt.savefig("images/standardization_comparison.png", dpi=300, bbox_inches='tight')
   ```
3. **Embed in Markdown**:
   ```markdown
   ![Caption](images/your_image.png)
   ```
