...
## 🖼️ Visual Output Generated directly from `exp4.ipynb` Code
...
1. **Output Directory**: Images are saved in `Experiment 4/images/`.
2. **Export Visual Outputs**:
   ```python
   plt.savefig("images/two_sample_ttest_output.png", dpi=300, bbox_inches='tight')
   ```
3. **Embed in Markdown**:
   ```markdown
